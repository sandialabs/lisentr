---
title: "Simulation: Varying Sigma"
...
**Overview**: This code runs a simulation study for the synthetic data when varying `sigmaX`, `sigmaDelta`, and `sigmaEpsilon`.
