#this script trains ESN and computes FI for E3SM prescribed ensembles 0x pinatubo
...
write.csv(fi,file=paste0("../output/gmd_paper/104d-e3sm_pscrb_",size,".csv"),row.names=FALSE)
