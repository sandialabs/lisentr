#this script trains ESN and computes FI for E3SM prescribed ensembles 1.5x pinatubo
...
write.csv(fi,file=paste0("../output/gmd_paper/104g-e3sm_pscrb_",size,".csv"),row.names=FALSE)
