# This script trains an ESN and FI to the E3SM fullvar 8 year run data to the counterfactual only
...
write.csv(fi,file=paste0("../output/gmd_paper/104a-e3sm_fullvar_cf.csv"),row.names=FALSE)
